  ...
  return (
    <div className="px-4 py-6 pb-24 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Link to="/conditions" className="bg-white border border-navy-800/10 shadow-sm text-navy-800 py-3 rounded-2xl text-sm font-semibold text-center">
          Live Conditions
        </Link>
      </div>
      ...
      <div className="bg-amber-500/10 border border-amber-500/30 rounded-2xl p-4 space-y-2">
        ...
        <p className="text-xs text-navy-700 leading-relaxed">Helpers provide guidance and dock support only. <span className="text-navy-800 font-semibold">Boat owners remain responsible for operating their vehicle, trailer, and vessel.</span> Helpers do not drive trucks or operate boats.</p>
      </div>

      {/* Why CDA */}
      <div className="space-y-3">
        <h2 className="text-sm font-semibold text-navy-800">Why Lake Coeur d'Alene?</h2>
      ...
      <div className="flex items-start gap-3 bg-white border border-navy-800/10 shadow-sm rounded-2xl p-4">
        ...
        <div>
          ...
          <p className="text-xs text-navy-700 mt-1">Every RampCrew helper on Lake Coeur d'Alene passes a government ID check, photo verification, and background review before working on the platform.</p>
        </div>
      </div>
