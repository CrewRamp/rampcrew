  ...
  return (
    <div className="px-4 py-6 pb-24 space-y-6">
      ...
      <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-3 flex items-center gap-3">
        ...
        <p className="text-xs text-yellow-200">RampCrew is expanding to Spirit Lake this season. <Link to="/helpers" className="font-semibold text-crew-blue underline">Apply to become a helper</Link> in your community.</p>
      </div>
      ...
      <div className="space-y-3">
        <h2 className="text-sm font-semibold text-navy-800">About Spirit Lake</h2>
